...
<body>
    ...
    <div class="container">
        ...
        <div class="unlimited_services mt-30 mb-30">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="services_section_thumb">
                            <img src="img/redwoman.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="unlimited_services_content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium, suscipit dolorum
